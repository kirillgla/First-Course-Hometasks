...
{
    // TODO: implement pushElementToStart
    fprintf(stderr, "pushElementToStart is not yet implemented.");
}

void pushValueToStart(LinkedList *list, Element *element)
{
    // TODO: implement pushValueToStart
    fprintf(stderr, "pushValueToStart is not yet implemented.\n");
}
...
{
    // TODO: implement pushValueToEnd
    fprintf(stderr, "pushListToEnd is not yet implemented.\n");
}
...
void printList(LinkedList *list, void (*printListElement)(LIST_VALUE_TYPE))
{
    if (list == NULL)
    {
        printf("NULL");
